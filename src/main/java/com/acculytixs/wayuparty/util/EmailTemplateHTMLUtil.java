					       ...
					       tempHTML.append("<table bgcolor='#ededed'  width='650' align='center' style='background-color:#ededed; padding:10px 15px; border:solid #E0E0E0; border-width:0 1px 0px 1px;'>");
					    	   tempHTML.append("<tr>");
				                 tempHTML.append("<td>");
				                   ...
				                   tempHTML.append("<p style='padding:0px 0px 2px 0px; margin:0px 0px; font-weight:400; font-size:11px; text-align:center'>For more information about WAYUPARTY, go to <a target='blank' href='https://wayuparty.net/' style='text-decoration:none; color:#0D47A1; display:inline-block; padding:0; border-radius:0; margin:0; font-size:14px'>wayuparty.net</a></p>");
				                 tempHTML.append("</td>");
				            tempHTML.append("</tr>");
