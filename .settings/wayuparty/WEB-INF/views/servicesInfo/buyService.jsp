<div class="ui-modal-box">
  <div class="modal-box">
   ...
   <script>
    			     ...
    			     success :function(response) {
    			    	...
    			    	var surpriseInstructions = '';
    			    	 ...
    			    	 addToCartElement.onclick = function() {
    			    		 addToCart(response.object.service,serviceUUID,categoryUUID,response.object.serviceId,response.object.vendorId,response.object.offerPrice,quantity,totalAmount,response.object.currency,surpriseDetails,surpriseInstructions)
    			    	 }
       ...
       function addToCart(service,serviceUUID,categoryUUID,vendorMasterServiceId,vendorId,offerPrice,quantity,totalAmount,currency,surpriseDetails,surpriseInstructions){
