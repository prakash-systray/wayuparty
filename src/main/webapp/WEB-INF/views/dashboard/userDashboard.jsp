					         ...
					         <div class="card mb-3 search_blo">
					            <div class="input-group search-blo">
					                ...
					                <div class="input-group-btn">
					                    <a class="btn btn-vendor-search"><span class="fa fa-sync-alt" onclick="clearClubSearch();"></span></a>
					                     <a href="#" class="btn btn-vendor-search" data-toggle="modal" data-target="#large-modal" onclick="getPopularCities()">
							            <img src="/resources/img/cities/loc-icon.png" alt="locate" /> Cities
							          </a>
					                </div>
		        	...
		        	if(resultData.data.length > 0){
			        	for (var i=0; i<resultData.data.length; i++)
		   				{  
			        		...
			        		result = result +'</div>';
			        		result = result +'<div class="bottom_left" style="bottom: 0px; right: 5px;">';
