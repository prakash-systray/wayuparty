	                            ...
	                            <ul class="nav nav-tabs" role="tablist">
	                                 <c:forEach var="service" items="${servicesList}">
	                                    <li class="nav-item mt-2">
	                                    	<a class="nav-link border-pastel-gold ${service.serviceId == 1 ? 'active' : ''}" data-toggle="tab" href="#orders" role="tab" aria-selected="true" onclick="getOrdersList('${service.serviceUUID}')"><img src="${service.serviceImage}"></img></a>
	                                	</li>
	                                 </c:forEach>
	                            </ul>
