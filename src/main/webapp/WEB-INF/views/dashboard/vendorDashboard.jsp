                    ...
                    <div class="col-xl-3 col-sm-6 col-12">
                        <div class="dashboard-summery-one mg-b-20">
                            <div class="row align-items-center">
                                ...
                                <div class="col-6">
                                    <div class="item-content">
                                        <div class="item-title">Save the Seat</div>
                    ...
                    <div class="col-xl-3 col-sm-6 col-12">
                        <div class="dashboard-summery-one mg-b-20">
                            <div class="row align-items-center">
                                ...
                                <div class="col-6">
                                    <div class="item-content">
                                        <div class="item-title">The WayU Party</div>
 ...
 function loadVendorsServicesSerialChart(result){
  var chart = AmCharts.makeChart("chartdiv", {
	    ...
	    "graphs": [{
	        ...
	        "balloonText": "Save the Seat: [[value]]",
	        "bullet": "round",
	        "columnWidth": 0.3,
	        "title": "Save the Seat",
	        "valueField": "table",
	        ...
	        "balloonText": "The WayU Party: [[value]]",
	        "bullet": "round",
	        "columnWidth": 0.3,
	        "title": "The WayU Party",
	        "valueField": "packages",
			"fillAlphas": 0
	    },{
	        "balloonText": "Make a Jump: [[value]]",
	        "bullet": "round",
	        "columnWidth": 0.3,
	        "title": "Make a Jump",
	        "valueField": "entry",
	        ...
	        "balloonText": "Make It Personal: [[value]]",
	        "bullet": "round",
	        "columnWidth": 0.3,
